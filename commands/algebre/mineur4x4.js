...
module.exports = {
  name: "mineur4x4",
  description:
    "Déterminer le mineur d'une matrice 4x4 et calculer son déterminant",
  category: "algebre",
  ...
  async run(bot, interaction) {
    ...
    const explanation = `\\begin{array}{c}
        ...
        \\begin{bmatrix}
            ${
              i === 1 || j === 1
                ? `{\\color{Red}${matrix4x4[0][0]}}`
                : matrix4x4[0][0]
            } & ${
      i === 1 || j === 2 ? `{\\color{Red}${matrix4x4[0][1]}}` : matrix4x4[0][1]
    } & ${
      i === 1 || j === 3 ? `{\\color{Red}${matrix4x4[0][2]}}` : matrix4x4[0][2]
    } & ${
      i === 1 || j === 4 ? `{\\color{Red}${matrix4x4[0][3]}}` : matrix4x4[0][3]
    } \\\\
            ${
              i === 2 || j === 1
                ? `{\\color{Red}${matrix4x4[1][0]}}`
                : matrix4x4[1][0]
            } & ${
      i === 2 || j === 2 ? `{\\color{Red}${matrix4x4[1][1]}}` : matrix4x4[1][1]
    } & ${
      i === 2 || j === 3 ? `{\\color{Red}${matrix4x4[1][2]}}` : matrix4x4[1][2]
    } & ${
      i === 2 || j === 4 ? `{\\color{Red}${matrix4x4[1][3]}}` : matrix4x4[1][3]
    } \\\\
            ${
              i === 3 || j === 1
                ? `{\\color{Red}${matrix4x4[2][0]}}`
                : matrix4x4[2][0]
            } & ${
      i === 3 || j === 2 ? `{\\color{Red}${matrix4x4[2][1]}}` : matrix4x4[2][1]
    } & ${
      i === 3 || j === 3 ? `{\\color{Red}${matrix4x4[2][2]}}` : matrix4x4[2][2]
    } & ${
      i === 3 || j === 4 ? `{\\color{Red}${matrix4x4[2][3]}}` : matrix4x4[2][3]
    } \\\\
            ${
              i === 4 || j === 1
                ? `{\\color{Red}${matrix4x4[3][0]}}`
                : matrix4x4[3][0]
            } & ${
      i === 4 || j === 2 ? `{\\color{Red}${matrix4x4[3][1]}}` : matrix4x4[3][1]
    } & ${
      i === 4 || j === 3 ? `{\\color{Red}${matrix4x4[3][2]}}` : matrix4x4[3][2]
    } & ${
      i === 4 || j === 4 ? `{\\color{Red}${matrix4x4[3][3]}}` : matrix4x4[3][3]
    } \\\\
        \\end{bmatrix} \\\\\\\\
      ...
      minorMatrix[1][2]
            ...
            ${minorMatrix[2][0]} & ${minorMatrix[2][1]} & ${
      minorMatrix[2][2]
    } \\\\
        \\end{bmatrix} \\\\\\\\
      ...
      minorMatrix[2][2]
        ...
        \\textbf{${minorMatrix[0][0]}} & \\textbf{{${
      minorMatrix[0][1]
    }}} & \\textbf{{${minorMatrix[0][2]}}} \\\\
        \\textbf{${minorMatrix[1][0]}} & \\textbf{${
      minorMatrix[1][1]
    }} & \\textbf{{${minorMatrix[1][2]}}} \\\\
        \\end{vmatrix} \\\\\\\\

        \\text{On va ensuite mettre en \\'{e}vidence les couleurs des \\textbf{diagonales de gauche \\\`{a} droite} de la matrice.} \\\\

        \\begin{vmatrix}
        {\\color{Red} ${minorMatrix[0][0]}} & ${minorMatrix[0][1]} & ${
      minorMatrix[0][2]
    } \\\\
        {\\color{DarkGreen} ${minorMatrix[1][0]}} & {\\color{Red} ${
      minorMatrix[1][1]
    }} & ${minorMatrix[1][2]} \\\\
        {\\color{Blue} ${minorMatrix[2][0]}} & {\\color{DarkGreen} ${
      minorMatrix[2][1]
    }} & {\\color{Red} ${minorMatrix[2][2]}} \\\\
        ${minorMatrix[0][0]} & {\\color{Blue} ${
      minorMatrix[0][1]
    }} & {\\color{DarkGreen} ${minorMatrix[0][2]}} \\\\
        ${minorMatrix[1][0]} & ${minorMatrix[1][1]} & {\\color{Blue} ${
      minorMatrix[1][2]
    }} \\\\
        \\end{vmatrix} \\\\\\\\
        ...
        \\text{On commence par la \\textbf{diagonale rouge} : (${
          minorMatrix[0][0]
        } × ${minorMatrix[1][1]} × ${minorMatrix[2][2]} = ${sumRed})} \\\\
        \\text{On passe ensuite \\\`{a} la \\textbf{diagonale verte} : (${
          minorMatrix[1][0]
        } × ${minorMatrix[2][1]} × ${minorMatrix[0][2]} = ${sumGreen})} \\\\
        \\text{Enfin, on passe \\\`{a} la \\textbf{diagonale bleue} : (${
          minorMatrix[2][0]
        } × ${minorMatrix[0][1]} × ${minorMatrix[1][2]} = ${sumBlue})} \\\\
        ...
        \\begin{vmatrix}
        ${minorMatrix[0][0]} & ${minorMatrix[0][1]} & {\\color{Red} ${
      minorMatrix[0][2]
    }} \\\\
        ${minorMatrix[1][0]} & {\\color{Red} ${
      minorMatrix[1][1]
    }} & {\\color{DarkGreen} ${minorMatrix[1][2]}} \\\\
        {\\color{Red} ${minorMatrix[2][0]}} & {\\color{DarkGreen} ${
      minorMatrix[2][1]
    }} & {\\color{Blue} ${minorMatrix[2][2]}} \\\\
        {\\color{DarkGreen} ${minorMatrix[0][0]}} & {\\color{Blue} ${
      minorMatrix[0][1]
    }} & ${minorMatrix[0][2]} \\\\
        {\\color{Blue} ${minorMatrix[1][0]}} & ${minorMatrix[1][1]} & ${
      minorMatrix[1][2]
    } \\\\
        \\end{vmatrix} \\\\\\\\
        ...
        \\text{On commence par la \\textbf{diagonale rouge} : (${
          minorMatrix[0][2]
        } × ${minorMatrix[1][1]} × ${minorMatrix[2][0]} = ${sumRed2})} \\\\
        \\text{On passe ensuite \\\`{a} la \\textbf{diagonale verte} : (${
          minorMatrix[1][2]
        } × ${minorMatrix[2][1]} × ${minorMatrix[0][0]} = ${sumGreen2})} \\\\
        \\text{Enfin, on passe \\\`{a} la \\textbf{diagonale bleue} : (${
          minorMatrix[2][2]
        } × ${minorMatrix[0][1]} × ${minorMatrix[1][0]} = ${sumBlue2})} \\\\
      ...
      sum - sum2
        ...
        \\textbf{Le d\\'{e}terminant de la matrice (et par cons\\'{e}quent, du mineur) est donc : ${
          sum - sum2
        }.} \\\\\\\\
    ...
    const attachmentStatement = new AttachmentBuilder(
      `https://latex.codecogs.com/png.latex?\\dpi{300}&space;\\bg_white&space;M=${encodeURIComponent(
        matrixToLatex(matrix4x4)
      )}`,
      { name: "matrix.png" }
    );
