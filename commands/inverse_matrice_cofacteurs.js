...
const { getCofactor, generateMatrix, determinantSarrus, generateEasyMatrix } = require("../utils/matrix");
const { matrixToLatex } = require("../utils/latex");

module.exports = {
    name: "inverse_matrice_cofacteurs",
    description: "Trouver l'inverse d'une matrice 3x3 avec la méthode des cofacteurs",
    ...
    async run(bot, interaction) {
        ...
        const statement = `**Inverse d'une matrice 3x3 avec la méthode des cofacteurs**\n\n` + 
        ...
        C_{1,1} = (${matrix[1][1]} * ${matrix[2][2]}) - (${matrix[1][2]} * ${matrix[2][1]}) = ${c11} \\qquad\\qquad\\qquad C_{1,2} = {\\color{Red}-1} * [(${matrix[1][0]} * ${matrix[2][2]}) - (${matrix[1][2]} * ${matrix[2][0]})] = ${c12} \\qquad\\qquad\\qquad C_{1,3} = (${matrix[1][0]} * ${matrix[2][1]}) - (${matrix[1][1]} * ${matrix[2][0]}) = ${c13} \\\\\\\
        C_{2,1} = {\\color{Red}-1} * [(${matrix[0][1]} * ${matrix[2][2]}) - (${matrix[0][2]} * ${matrix[2][1]})] = ${c21} \\qquad\\qquad\\qquad C_{2,2} = (${matrix[0][0]} * ${matrix[2][2]}) - (${matrix[0][2]} * ${matrix[2][0]}) = ${c22} \\qquad\\qquad\\qquad C_{2,3} = {\\color{Red}-1} * [(${matrix[0][0]} * ${matrix[2][1]}) - (${matrix[0][1]} * ${matrix[2][0]})] = ${c23} \\\\\\\
        C_{3,1} = (${matrix[0][1]} * ${matrix[1][2]}) - (${matrix[0][2]} * ${matrix[1][1]}) = ${c31} \\qquad\\qquad\\qquad C_{3,2} = {\\color{Red}-1} * [(${matrix[0][0]} * ${matrix[1][2]}) - (${matrix[0][2]} * ${matrix[1][0]})] = ${c32} \\qquad\\qquad\\qquad C_{3,3} = (${matrix[0][0]} * ${matrix[1][1]}) - (${matrix[0][1]} * ${matrix[1][0]}) = ${c33} \\\\\\\\\\\
